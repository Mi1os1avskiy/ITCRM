...
class BillingController
{
	...
	public static function allTransactions() {
		$list = [
			...
			['id' => 'TC09862324260957', 'date' => '17/08/2023, 13:17 (MSK)', 'invoice_exist' => 0, 'invoice_type' => 8, 'invoice' => '83372', 'client' => 'ultrices@mail.com', 'method' => 'webmoney (rh)', 'description' => 'Оплата инвойса с входящей транзакции', 'refund' => 0, 'amount' => 23, 'status' => 'Возвращена', 'details' => ['name' => 'Удаление кредита', 'id' => 3]],
			['id' => 'TC09862324260957', 'date' => '17/08/2023, 13:17 (MSK)', 'invoice_exist' => 0, 'invoice_type' => 3, 'invoice' => '', 'client' => 'vulputate@mail.com', 'method' => 'payserra', 'description' => 'Оплата инвойса с входящей транзакции', 'refund' => 1, 'amount' => 1200, 'status' => 'Засчитана', 'details' => ['name' => 'Добавление кредита', 'id' => 2]],
