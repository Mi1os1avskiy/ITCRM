...
class UsersController
{
    ...
    public static function CreateTable() {
        return [
            ...
            new UsersController(222, 'miloslavskiy@tut.by', 'Aleksandr Miloslavskiy', 1200, 1, 'Unconfirmed', '17/02/2023', 'Ru', '+375 29 638-33-96', ['Belarus', 'Minsk', 'Kollektornaya, 32-60', '220004'], 'BrainQ', ['date' => '11/04/2023', 'time' => '14:21:32', 'ip' => '37.214.25.177', 'geo' => 'BY'], '37.214.25.177', 'BY', 1),
            ...
            new UsersController(555, 'sapolsky@stanford.com', 'Robert Sapolsky', 1234, 8, 'Unconfirmed', '17/02/2023', 'En', '+44 235 42-31-64', ['England', 'London', 'Baker st, 221B', '38752'], 'Stanford University', ['date' => '11/04/2023', 'time' => '14:21:32', 'ip' => '37.214.25.177', 'geo' => 'GB'], '37.214.25.177', 'GB', 0),
        ];
    }
    ...
    public static function ClientsData() {
        $list = [
            ['id' => 111,
                ...
                'credits' => [
                    ['date' => '17/02/2023', 'time' => '17:30', 'country' => 'MSK', 'method' => 'Баланс', 'id' => '', 'user' => '', 'appointment_type' => 1, 'appointment' => 'Инвойс 4833749', 'amount_stat' => 'low', 'amount' => 9.99, 'description' => 'Оплата инвойса с входящей транзакции'],
                    ['date' => '17/02/2023', 'time' => '17:30', 'country' => 'MSK', 'method' => 'Баланс', 'id' => '', 'user' => '', 'appointment_type' => 1, 'appointment' => 'Инвойс 4833749', 'amount_stat' => 'high', 'amount' => 19.99, 'description' => 'Оплата инвойса с баланса клиента'],
                    ['date' => '17/02/2023', 'time' => '17:30', 'country' => 'MSK', 'method' => 'Баланс', 'id' => '', 'user' => '', 'appointment_type' => 0, 'appointment' => 'Баланс', 'amount_stat' => 'low', 'amount' => 200, 'description' => 'Credit to the balance from the transaction (balance)'],
                    ['date' => '17/02/2023', 'time' => '17:30', 'country' => 'MSK', 'method' => 'Custom', 'id' => '23202', 'user' => 'Admin', 'appointment_type' => 1, 'appointment' => 'Инвойс 4833749', 'amount_stat' => 'normal', 'amount' => 50, 'description' => 'Оплата инвойса с входящей транзакии'],
                    ['date' => '17/02/2023', 'time' => '17:30', 'country' => 'MSK', 'method' => 'Баланс', 'id' => '', 'user' => '', 'appointment_type' => 1, 'appointment' => 'Инвойс 4833749', 'amount_stat' => 'low', 'amount' => 999.99, 'description' => 'Оплата инвойса с входящей транзакции'],
                ],
                'emails' => [
